...
function M.check()
	...
	local cmd = "arduino-cli compile --fqbn " .. M.board .. " " .. vim.fn.shellescape(vim.fn.expand("%:p:h"))
...
function M.upload()
	...
	local compile_cmd = "arduino-cli compile --fqbn " .. M.board .. " " .. vim.fn.shellescape(vim.fn.expand("%:p:h"))
...
vim.api.nvim_create_user_command("InoUploadReset", function()
	...
	vim.defer_fn(function()
		...
		local upload_cmd = "arduino-cli upload -p " .. M.port .. " --fqbn " .. M.board .. " " .. vim.fn.shellescape(vim.fn.expand("%:p:h"))
